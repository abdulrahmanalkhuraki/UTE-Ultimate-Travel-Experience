...
{
    /// <summary>Mapping profile for RejectedTourPackageResponse DTO.</summary>
    public class RejectedTourPackageProfile : Profile
    {
        public RejectedTourPackageProfile()
        {
            CreateMap<TourPackage, RejectedTourPackageResponse>()
