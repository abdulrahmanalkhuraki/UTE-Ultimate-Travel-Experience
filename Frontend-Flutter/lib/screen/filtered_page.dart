...
class _FilteredPageState extends State<FilteredPage> {
  ...
  final List<Map<String, dynamic>> _defaultProgramsData = [
    {
      'id': '1',
  ...
  List<Map<String, dynamic>> get programsData =>
      widget.programs ?? _defaultProgramsData;
                        ...
                        children: [
                          ...
                          Expanded(
                            child: FittedBox(
                              ...
                              child: CustomHeaderTitle(title: widget.title),
                            ),
                          ),
                                                      ...
                                                      children: [
                                                        Row(
                                                          children: List.generate(5, (starIndex) {
                                                            final int rating =
                                                                (currentProgram['rating'] as int?) ?? 0;
                                                            final bool isFilled = rating > starIndex;
                                                            return Padding(
