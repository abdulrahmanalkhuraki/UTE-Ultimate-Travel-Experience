                              ...
                              children: [
                                ...
                                Expanded(
                                  child: FittedBox(
                                    ...
                                    child: CustomHeaderTitle(title: 'الملف الشخصي'),
                                  ),
                                ),
                                const SizedBox(width: 48, child: CustomBackButton()),
                              ],
                            ),
                          ),
                        ...
                        Image.asset(
                          ...
                          fit: BoxFit.contain,
                                    ...
                                    Center(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 8),
                                          Text(
                                            'السكن الحالي:    ${user.currentLocation}',
                                            style: const TextStyle(fontFamily: 'Tajawal', fontSize: 16),
                                            textAlign: TextAlign.center,
                                          ),
                                          const SizedBox(height: 4),
                                          Text(
                                            'مكان الإقامة:    ${user.residence}',
                                            style: const TextStyle(fontFamily: 'Tajawal', fontSize: 16),
                                            textAlign: TextAlign.center,
                                          ),
                                        ],
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        _buildDataRow(" تاريخ الانضمام :", user.joinDate),
                                        _buildDataRow(" عدد البرامج التي انضممت لها :", user.programCount),
                                        _buildDataRow(" عدد الشركات التي سافرت معها :", user.companiesCount),
                                        _buildDataRow(" عدد الرحلات التي قمت بها :", user.tripsCount),
                                        _buildDataRow(" عدد المرافقين :", user.accompanierCount),
                                        _buildDataRow(
                            ...
                            _buildImageSlider(
                              ...
                              frontImage: user.idImageFront,
                              backImage: user.idImageBack,
                            ...
                            _buildImageSlider(
                              ...
                              frontImage: user.passportImageFront,
                              backImage: user.passportImageBack,
