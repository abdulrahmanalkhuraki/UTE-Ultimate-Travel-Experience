...
class _CompanyInfoScreenState extends State<CompanyInfoScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // تم تعديل المسافات لتطابق شاشة الـ Owner تماماً بدون تداخل
    const double fieldSpacing = 85.0;
    const double firstFieldTop = 415.0; // نزلنا بالحقول قليلاً لتطابق تصميمك الجديد
    ...
    final double foundingBoxTop = 895.0; // القياس الدقيق الذي أرسلته
    ...
    final double aboutCompanyTop = bankAccountTop + 95; // 1550
    const double aboutCompanyHeight = 260.0;

    final double submitButtonTop = aboutCompanyTop + aboutCompanyHeight + 40; // 1850
          ...
          child: SingleChildScrollView(
            child: SizedBox(
              ...
              child: Stack(
                ...
                children: [
                  // 🌟 حل مشكلة الفيكتور ليكون مطابقاً لواجهة المرافق (بدون كلر فلتر)
                  Positioned(
                    top: 0,
                    left: 0,
                    right: 0,
                  ...
                  // 🌟 تعديل حجم وخط عنوان الواجهة حسب خصائص فيغما
                  Positioned(
                    top: 99 * scale,
                    left: 41 * scale,
                    width: 357 * scale,
                  ...
                  // تم إنزال اللوجو قليلاً ليتناسب مع العنوان
                  Positioned(
                    top: 160 * scale,
                    left: 120 * scale,
                    width: 200 * scale,
                  ...
                  // 🌟 إحداثيات زر الشهر (left: 245, top: 895)
                  _buildDateBox(
                    scale: scale,
                    top: foundingBoxTop,
                    left: 245,
                  ...
                  // 🌟 إحداثيات زر السنة (left: 95, top: 895)
                  _buildDateBox(
                    scale: scale,
                    top: foundingBoxTop,
                    left: 95,
  ...
  Widget _buildAboutCompanyField({
    ...
    return Positioned(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: Colors.white,
          border: Border.all(color: Colors.grey.shade400, width: 1.2 * scale),
          borderRadius: BorderRadius.circular(15 * scale),
        ),
        child: Stack(
          clipBehavior: Clip.none,
