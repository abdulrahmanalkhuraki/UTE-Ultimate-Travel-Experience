...
class EditCompanionScreen extends StatefulWidget {
  final Map<String, String>? companionData;

  const EditCompanionScreen({super.key, this.companionData});
...
class _EditCompanionScreenState extends State<EditCompanionScreen> {
  ...
  void initState() {
    ...
    if (widget.companionData != null) {
      final nameParts = (widget.companionData!['name'] ?? '').split(' ');
      firstNameController.text = nameParts.isNotEmpty ? nameParts[0] : '';
      lastNameController.text =
      nameParts.length > 1 ? nameParts.sublist(1).join(' ') : '';
      relationController.text = widget.companionData!['relation'] ?? '';
      nationalIdController.text = widget.companionData!['id'] ?? '';
      selectedAge = 'فوق 18 سنة';
    }
  }
  ...
  Future<void> _pickImage(String type) async {
    ...
    if (pickedFile != null) {
      setState(() {
        ...
        if (type == 'residence') residenceImageFile = File(pickedFile.path);
      });
    }
  }
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (picked != null && picked != selectedDob) setState(() =>
    selectedDob = picked);
  }
  ...
  void _submitCompanion() {
    if (firstNameController.text.isEmpty || lastNameController.text.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('الرجاء تعبئة جميع الحقول الإلزامية',
  ...
  Widget build(BuildContext context) {
    ...
    final Color borderColor = isDarkMode ? Colors.white24 : Colors.black;
    final Color fieldBgColor = isDarkMode ? const Color(0xFF2C3E50).withOpacity(
        0.5) : Colors.white;
    ...
    if (selectedAge == 'من 14 إلى 18 سنوات' || selectedAge == 'فوق 18 سنة') {
      dynamicFields.addAll(_buildTextInputField(scale: scale,
          top: currentTop,
      ...
      currentTop += 95.0;
      dynamicFields.addAll(_buildImageUploadFrame(scale: scale,
          top: currentTop,
    ...
    return Scaffold(
      backgroundColor: isDarkMode ? const Color(0xFF1E1E1E) : const Color(
          0xFFFFFFFF),
                ...
                children: [
                  Positioned(
                    ...
                    child: SvgPicture.asset(
                      ...
                      width: size.width,
                      fit: BoxFit.cover,
                      colorFilter: isDarkMode ? const ColorFilter.mode(
                          Color(0xFF223A5E), BlendMode.srcIn) : null,
                    ),
                  ),
                  Positioned(
                    top: 42 * scale,
                    ...
                    child: GestureDetector(
                      ...
                      child: SvgPicture.asset(
                        ...
                        fit: BoxFit.contain,
                        colorFilter: isDarkMode ? const ColorFilter.mode(Colors
                            .white, BlendMode.srcIn) : null,
                      ),
                    ),
                  ),

                  // 🌟 هون تم إصلاح كلمة (تعديل المعلومات) لتضل موصولة
                  Positioned(
                    top: 25 * scale,
                    left: 45 * scale,
                    width: 350 * scale,
                  ...
                  Positioned(
                    ...
                    child: GestureDetector(
                      ...
                      child: companionProfileImage != null
                          ? ClipOval(
                          child: Image.file(companionProfileImage!, width: 200 *
                              scale, height: 200 * scale, fit: BoxFit.cover))
                  ...
                  ..._buildTextInputField(scale: scale,
                      top: 365,
                  ...
                  Positioned(
                    ...
                    height: 80 * scale,
                    child: SvgPicture.asset(
                        'assets/icons/fORm.svg', fit: BoxFit.contain,
                        colorFilter: isDarkMode ? const ColorFilter.mode(
                            Colors.white54, BlendMode.srcIn) : null),
                  ),
                  Positioned(
                    top: 875 * scale,
                    left: 75 * scale,
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(color: fieldBgColor,
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      width: 24 * scale,
                                      height: 24 * scale,
                                      child: Icon(isGenderDropdownOpen ? Icons
                                          .keyboard_arrow_up : Icons
                                          .keyboard_arrow_down,
                                          size: 20 * scale, color: textColor),
                                    ),
                                    SizedBox(width: 10 * scale),
                                    Directionality(
                                      textDirection: TextDirection.rtl,
                                      child: Text(selectedGender ?? 'الجنس:',
                                          style: TextStyle(
                                              fontFamily: 'Tajawal',
                                              fontSize: 24 * scale,
                                        ...
                                        decoration: BoxDecoration(
                                            border: Border(top: BorderSide(
                                                color: isDarkMode ? Colors
                                                    ...
                                                    .shade300))),
                                        child: Text(
                                            gender, textAlign: TextAlign.center,
                                            style: TextStyle(
                                                fontFamily: 'Tajawal',
                                                fontSize: 20 * scale,
                                                fontWeight: FontWeight.w500,
                  ...
                  Positioned(
                    ...
                    child: Directionality(
                      textDirection: TextDirection.rtl,
                      child: Text(
                          'أدخل تاريخ ميلاده:', textAlign: TextAlign.center,
                          style: TextStyle(
                              fontFamily: 'Tajawal', fontWeight: FontWeight
                              .w500, fontSize: 24 * scale, color: textColor)),
                    ),
                  ),
                  _buildDateBox(scale: scale,
                      top: dobTop + 46,
                      left: 290,
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        decoration: BoxDecoration(color: const Color(
                            0xFFF4A261), borderRadius: BorderRadius.circular(
                            15 * scale)),
                        child: Stack(
                          alignment: Alignment.center,
                          children: [
                            Text('حفظ التعديلات', style: TextStyle(
                                fontFamily: 'Tajawal',
                                fontWeight: FontWeight.w500,
                                fontSize: 24 * scale,
                                color: Colors.white)),
  ...
  List<Widget> _buildTextInputField({
    required double scale, required double top, required String hintText, required String assetPath,
    required bool isSvg, TextEditingController? controller,
    required Color textColor, required Color borderColor, required Color fieldBgColor, required bool isDarkMode,
  }) {
    return [
      Positioned(
        top: top * scale,
  ...
  Widget _buildDateBox({
    required double scale, required double top, required double left, required String text,
    required VoidCallback onTap, required Color textColor, required Color borderColor, required Color fieldBgColor,
  }) {
    return Positioned(
      top: top * scale,
      left: left * scale,
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                child: Icon(Icons.keyboard_arrow_down, size: 20 * scale,
                    color: textColor.withOpacity(0.5)),
              ),
              ...
              Text(text, style: TextStyle(fontFamily: 'Tajawal',
                  fontWeight: FontWeight.w500,
                  fontSize: 20 * scale,
                  color: selectedDob != null ? textColor : textColor
                      .withOpacity(0.5))),
            ],
          ),
        ),
  ...
  List<Widget> _buildImageUploadFrame({
    required double scale, required double top, required String title, required double titleLeft, required double titleWidth,
    File? imageFile, required VoidCallback onTap, required Color textColor, required bool isDarkMode,
  }) {
    return [
      Positioned(
        top: top * scale, left: titleLeft * scale, width: titleWidth * scale,
        child: Directionality(
          textDirection: TextDirection.rtl,
      ...
      Positioned(
        ...
        child: GestureDetector(
          ...
          child: Stack(
            children: [
              SvgPicture.asset('assets/icons/picFrame.svg', width: 340 * scale,
                  height: 319.6 * scale,
                  fit: BoxFit.fill,
                  colorFilter: isDarkMode ? const ColorFilter.mode(
                      Colors.white24, BlendMode.srcIn) : null),
              Center(
                child: imageFile != null
                    ? ClipRRect(borderRadius: BorderRadius.circular(15 * scale),
                    child: Image.file(imageFile, width: 320 * scale,
                        height: 300 * scale,
                        fit: BoxFit.cover))
                    : SvgPicture.asset(
                    'assets/icons/Image.svg', width: 100 * scale,
                    height: 100 * scale,
                    colorFilter: ColorFilter.mode(textColor, BlendMode.srcIn)),
              ),
            ],
