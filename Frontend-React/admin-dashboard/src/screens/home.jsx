...
const growthData = [
  { name: 'Feb', tourists: 50 },
  { name: 'Jan', tourists: 30 },
  { name: 'Mar', tourists: 65 },
  { name: 'Apr', tourists: 55 },
  { name: 'May', tourists: 70 },
  { name: 'Jun', tourists: 95 },
  { name: 'Jul', tourists: 75 },
  { name: 'Aug', tourists: 90 },
  { name: 'Sep', tourists: 110 },
  { name: 'Oct', tourists: 105 },
  { name: 'Nov', tourists: 120 },
  { name: 'Dec', tourists: 135 },
];
...
export default function Home() {
  ...
  const [programRows, setProgramRows] = useState([
    { name: 'Alpine Explorer', trip: 'Alpine Explorer', comp: 'Summit Treks Ltd.' },
    { name: 'Desert Safari Ext.', trip: 'Desert Safari Ext.', comp: 'Dune Navigators' },
    { name: 'Coastal Retreat', trip: 'Coastal Retreat', comp: 'Oceanic Ventures' }
  ]);
  const [companyRows, setCompanyRows] = useState([
    { name: 'Global Trails Inc.', comp: 'Global Trails Inc.', since: '5 days ago' },
    { name: 'Urban Odyssey', comp: 'Urban Odyssey', since: '2 days ago' },
    { name: 'Eco Escapes LLC', comp: 'Eco Escapes LLC', since: '1 day ago' }
  ]);
  ...
  const handleProgramRowClick = (row) => {
    setSelectedProgram({ name: row.trip, companyName: row.comp });
    setSelectedCompany(null);
  };

  const handleCompanyRowClick = (row) => {
    setSelectedCompany({ name: row.comp, logo: row.logo });
